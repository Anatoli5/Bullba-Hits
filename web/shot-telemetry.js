...
(function(root){
  ...
  function show(){
    ...
    if(aim){
      ...
      if(aim.selectedShell)text('Shell selected at the command: '+aim.selectedShell.name+' · '+format(aim.selectedShell.penetration100)+' / '+format(aim.selectedShell.penetration500)+' mm at 100 / 500 m');
